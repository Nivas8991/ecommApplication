...
function validation()
{
	var e=document.reg.cname.value;
if(e=="")
	{
	alert("Please Enter Your Card Number Name ")
		document.reg.cname.focus();
	return false;
	}
	if(isNaN(e))
	{
		alert("Card Number Must be Numaric");
		document.reg.cname.focus()
			return false;
	}
	if(e.length!=12)
	{
		alert("Card Number Must Be 12 Numbers");
		document.reg.cname.focus();
		return false;
	}
	
	var f=document.reg.ctype.value;
if(f=="0")
	{
	alert("Please Select Your Card Type ")
		document.reg.ctype.focus();
	return false;
	}
	var g=document.reg.name.value;
if(g=="")
	{
	...
	var h=document.reg.number.value;
	if(h=="")
	{
	...
	if(isNaN(h))
	{
		alert("CVV Number Must be Numaric");
		document.reg.number.focus()
			return false;
	}
	if(h.length!=3)
	{
		alert("CVV Number Must Be 3 Numbers");
		document.reg.number.focus();
		return false;
	}
...
<div id="mainblock">
  <div id="innerblock">
   ...
   <div>
   <table>
   <form name="reg" action="final1.jsp" method="post" onSubmit=" return validation()">
			<table >
	...
	<tr><td  align="right" ><font color="white">Card Type&nbsp;&nbsp;&nbsp;:</td>
	...
	<tr ><td  align="right"><font color="white">Name On The Card&nbsp;&nbsp;&nbsp;:</td>
    <td class="s1"><input  type="text" name="name" ></td></tr>
	<tr ><td height="10"></td>
    </tr>
	
	<tr ><td  align="right"><font color="white">CVV Number&nbsp;&nbsp;&nbsp;:</td>
    <td><input type="password" name="number" ></td></tr>
	<tr ><td height="10"></td>
    <tr><td align="right"><font color="white">Expried Date&nbsp;&nbsp;&nbsp;:</td>
