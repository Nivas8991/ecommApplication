...
<table cellspacing="20" border="2" width="600px;">
			 <tr><th><font color="red">Product  catageory</font></th><th><font color="red">Product Company</font></th><th><font color="red">Product Model</font></th><th><font color="red">Price</font></th><th><font color="red">Features</font></th><th><font color="red">Delete Product</font></th></tr>
			 <%while(rs.next())
			{
				%>
			 <tr>
		...
		<td><a href="delete1.jsp?pcat=<%=rs.getString(1)%>&pcompany=<%=rs.getString(2)%>&pmodel=<%=rs.getString(3)%>&price=<%=rs.getString(4)%>&features=<%=rs.getString(5)%>"><font color="green">Delete </font></td>
